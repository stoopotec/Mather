...
enum symbol_type {
    ...
    PLUS                        = 0b0000010000000000000000000000000000000000000000010000000000000000,
    MINUS                       = 0b0000010000000000000000000000000000000000000000010000000000000001,

    MULTIPLY                    = 0b0000010000000000000000000000000000000000000000100000000000000010,
    DIVIDE                      = 0b0000010000000000000000000000000000000000000000100000000000000011,
